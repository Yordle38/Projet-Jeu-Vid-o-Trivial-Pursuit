...
public class Game1 : Game
{
    ...
    private Case _case2;
    private Plateau _plateau;
    private Texture2D _texturePion;
    private Pion _pion;
    private int _casseActuelle;
    private Random _random;
    private bool _seDeplace = true;
    ...
    protected override void LoadContent()
    {
        ...
        _textureCase = Content.Load<Texture2D>("Images/case_3");
        _backgroundPlateau = Content.Load<Texture2D>("Images/fond_plateau");
        _texturePion=Content.Load<Texture2D>("Images/pion");
    ...
    var cases = new List<Case>
{
    ...
    new Case(new Vector2(1070, 720), 130, Color.White, TypeCase.VIDE, _textureCase),
        ...
        // Initialiser le plateau avec la liste de cases et l'image de fond
        _plateau = new Plateau(_backgroundPlateau, cases);
        // Initialiser le pion sur la premiere case du plateau
        _pion = new Pion(cases[_casseActuelle], _texturePion);
    }
    ...
    protected override void Update(GameTime gameTime)
    {
        ...
        if (Keyboard.GetState().IsKeyDown(Keys.Space) && _seDeplace)
        {
            int deplacer = _random.Next(1, 7);
            deplacerPion(deplacer);
        }
    ...
    private void deplacerPion(int deplacer)
    {
        _casseActuelle = (_casseActuelle + deplacer) % _plateau.NombreCases;
        _pion.Deplacer(_plateau.getCase(_casseActuelle));
    }
