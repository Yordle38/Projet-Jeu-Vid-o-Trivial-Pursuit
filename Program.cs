...
namespace TrivialPursuit.chap
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           partie p = new partie(c, cartesList1 );

            // Serialisation 
            string filePath = Path.Combine("..", "..", "..", "xml", "partie.xml");
            XMLUtils.Serialization(p, filePath);
            ...
            */
           string filePath1 = Path.Combine("..", "..", "..", "xml", "questionDesCategories.xml");
           Categories ct = XMLUtils.Deserialization<Categories>(filePath1);
